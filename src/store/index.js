 ...
 * @LastEditTime: 2020-08-09 18:27:02
...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        stats: (state, jsonVal) => {
            let json = Object.assign(state.stats, jsonVal);
            state.stats = JSON.parse(JSON.stringify(json));
        },
    },
    actions: {
        ...
        stats: (context, jsonVal) => context.commit("stats", jsonVal),
    }
});
